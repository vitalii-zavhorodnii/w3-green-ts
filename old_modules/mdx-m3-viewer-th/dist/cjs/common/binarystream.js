...
class BinaryStream {
    ...
    readInt8() {
        ...
        const index = this.index;
        const uint8array = this.uint8array;
        const data = typecast_1.uint8ToInt8(uint8array[index]);
        this.index += 1;
        this.remaining -= 1;
        return data;
    }
    ...
    readInt16() {
        ...
        const index = this.index;
        const uint8array = this.uint8array;
        const data = typecast_1.uint8ToInt16(uint8array[index], uint8array[index + 1]);
        this.index += 2;
        this.remaining -= 2;
        return data;
    }
    ...
    readInt32() {
        ...
        const index = this.index;
        const uint8array = this.uint8array;
        const data = typecast_1.uint8ToInt32(uint8array[index], uint8array[index + 1], uint8array[index + 2], uint8array[index + 3]);
        this.index += 4;
        this.remaining -= 4;
        return data;
    }
    ...
    readUint16() {
        ...
        const index = this.index;
        const uint8array = this.uint8array;
        const data = typecast_1.uint8ToUint16(uint8array[index], uint8array[index + 1]);
        this.index += 2;
        this.remaining -= 2;
        return data;
    }
    ...
    readUint32() {
        ...
        const index = this.index;
        const uint8array = this.uint8array;
        const data = typecast_1.uint8ToUint32(uint8array[index], uint8array[index + 1], uint8array[index + 2], uint8array[index + 3]);
        this.index += 4;
        this.remaining -= 4;
        return data;
    }
    ...
    readFloat32() {
        ...
        const index = this.index;
        const uint8array = this.uint8array;
        const data = typecast_1.uint8ToFloat32(uint8array[index], uint8array[index + 1], uint8array[index + 2], uint8array[index + 3]);
        this.index += 4;
        this.remaining -= 4;
        return data;
    }
    ...
    readFloat64() {
        ...
        const index = this.index;
        const uint8array = this.uint8array;
        const data = typecast_1.uint8ToFloat64(uint8array[index], uint8array[index + 1], uint8array[index + 2], uint8array[index + 3], uint8array[index + 4], uint8array[index + 5], uint8array[index + 6], uint8array[index + 7]);
        this.index += 8;
        this.remaining -= 8;
        return data;
    }
     ...
     */
    write(utf8) {
        const bytes = utf8_1.encodeUtf8(utf8);
