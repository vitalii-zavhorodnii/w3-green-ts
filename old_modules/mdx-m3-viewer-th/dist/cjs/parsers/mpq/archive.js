...
class MpqArchive {
    ...
    load(buffer, readonly = false) {
        ...
        const headerOffset = isarchive_1.searchHeader(bytes);
        if (headerOffset === -1) {
        ...
        const hashPos = typecast_1.numberToUint32(uint32array[4] + headerOffset); // Whoever thought of MoonLight, clever!
        const blockPos = typecast_1.numberToUint32(uint32array[5] + headerOffset);
