export const VFX = {
  fade: 'ReplaceableTextures\\CameraMasks\\Black_mask.blp',
  Teleport: 'Abilities\\Spells\\HumanMassTeleport\\MassTeleportCaster.mdl',
  HolyBolt: 'Abilities\\Spells\\Human\\HolyBolt\\HolyBoltSpecialArt.mdl',
  Resource: 'Abilities\\Spells\\Items\\ResourceItems\\ResourceEffectTarget.mdl',
  BlinkPoint: 'Abilities\\Spells\\NightElf\\Blink\\BlinkTarget.mdl',
